...
class HashSet {
  private:
    ...
    const std::vector<std::size_t> sizes {1ul, 13ul, 59ul, 127ul, 257ul, 541ul,
                                          1'109ul, 2'357ul, 5'087ul, 10'273ul, 
                                          20'753ul, 42'043ul, 85'229ul, 172'933ul, 
                                          351'061ul, 712'697ul, 1'447'153ul, 2'938'679ul};

    // define the member variables you need for your solution here
    std::list<int> master_list;
    std::vector<std::list<int>::iterator> hash_set;
    float load_factor;
    float max_load_factor;
    std::size_t num_element;
    std::size_t current_size_index;
  public:
